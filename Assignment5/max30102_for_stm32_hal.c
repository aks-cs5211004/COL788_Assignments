...
//
//    // Print the interrupt status registers for debugging
////    printf("Interrupt Reg[0]: 0x%02X, Reg[1]: 0x%02X\n", reg[0], reg[1]);
//    printf("Reg[1]: 0x%02X\n", reg[1]);
//
//
...
//        printf("Sample %d - IR Sample: %lu, Red Sample: %lu\n", i, ir_sample, red_sample);
...
//    max30102_read(obj, MAX30102_FIFO_DATA, fifo_data, 6);
//    ir_sample = (fifo_data[0] << 16) | (fifo_data[1] << 8) | fifo_data[2];
//    red_sample = (fifo_data[3] << 16) | (fifo_data[4] << 8) | fifo_data[5];
//    obj->_ir_samples[obj->_ir_sample_index] = ir_sample;
//    obj->_red_samples[obj->_red_sample_index] = red_sample;
//    max30102_plot(ir_sample, red_sample);
//    obj->_ir_sample_index = (obj->_ir_sample_index + 1) % MAX30102_SAMPLE_LEN_MAX;
//    obj->_red_sample_index = (obj->_red_sample_index + 1) % MAX30102_SAMPLE_LEN_MAX;
//}
